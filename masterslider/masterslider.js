...
;(function($){
	...
	window.MasterSlider = function(){
		...
		this.options = {
			...
			mouse				: false,		  // Whether the user can use mouse drag navigation.
			swipe				: false,		  // Whether the drag/swipe navigation is enabled.
			...
			inView				: 1, 		  // Specifies number of slides which will be added at a same time in DOM.
			critMargin			: 1,		  //
			heightLimit			: true,		  // It force the slide to use max height value as its base specified height value.
			smoothHeight		: false,		  // Whether the slider uses smooth animation while its height changes.
			...
			hideLayers			: true,	  // Whether the slider hides all layers before changing slide.
